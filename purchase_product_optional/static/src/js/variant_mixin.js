odoo.define('purchase_product_optional.VariantMixin', function (require) {
    'use strict';
    ...
    var VariantMixin = {
        ...
        _getCombinationInfo: function (ev) {
            ...
            if ($parent.hasClass('main_product')) {
                ...
                for (const optionalProduct of $optProducts) {
                    ...
                    ajax.jsonRpc(this._getUri('/purchase_product_optional/get_combination_info'), 'call', {
            ...
            return ajax.jsonRpc(this._getUri('/purchase_product_optional/get_combination_info'), 'call', {
        ...
        selectOrCreateProduct: function ($container, productId, productTemplateId, useAjax) {
            ...
            if (productId) {
                ...
                var route = '/purchase_product_optional/create_product_variant';
                if (useAjax) {
