...
class ProductConfiguratorPurchaseController(Controller):
    ...
    def get_product_configurator_values_purchase(
        ...
        :param str so_date: The date of the `purchase.order`, to compute the price at the right rate.
    ...
    def purchase_product_optional_update_combination(
        ...
        return self._get_basic_product_information_purchase(
    ...
    def _get_product_information_purchase(
        self,
        product_template,
        combination,
        currency_id,
        ...
        :return: A dict with the following structure:
            {
                'product_tmpl_id': int,
                'id': int,
                'description_purchase': str|False,
                'display_name': str,
                'price': float,
                'quantity': int
                'attribute_line': [{
        ...
        return dict(
            ...
            **self._get_basic_product_information_purchase(
                product or product_template,
                pricelist,
                combination,
                quantity=quantity,
